    ...
    return (
        <>
            <div className={props.className}>
                <img className="mx-auto mb-2" src='https://www.iqair.com/assets/img/enterprise/air-api/il-world-coverage.svg' alt="world-wide coverage icon" />
            ...
            <div className={props.className}>
                <img className="mx-auto mb-2" src="https://www.iqair.com/assets/img/enterprise/air-api/il-ai.svg" alt="artificial intelligence icon"/>
            ...
            <div className={props.className}>
                <img className="mx-auto mb-2" src='https://www.iqair.com/assets/img/enterprise/air-api/il-support.svg' alt="customer support icon" />
