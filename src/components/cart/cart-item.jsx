                        ...
                        <div className="col-6 pr-5" >
                            ...
                            <div className="row d-flex align-items-center mt-2 text-center">
                                <div className="col-3 offset-1 ">
                                    <button className="btn btn-success cart-item--btn-success scart-product-button-container"><p className="lead scart-product-plus-button" onClick={addQuantity}>+</p></button>
                                </div>
                                <div className="col-3">
                                    <p className="lead" style={{ paddingLeft: "1rem" }} id="product-details-quantity">{item.quantity}</p>
                                </div>
                                <div className="col-3">
                                    <button className="btn btn-success cart-item--btn-success scart-product-button-container"><p className="lead scart-product-plus-button" id="product-details-plus-button" onClick={deductQuantity}>-</p></button>
                                </div>
                                <div className="col-12">
